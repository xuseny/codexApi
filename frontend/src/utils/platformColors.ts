...
export type Platform = 'anthropic' | 'openai' | 'windsurf' | 'kiro' | 'antigravity' | 'gemini'
...
const BADGE: Record<Platform, string> = {
  ...
  windsurf: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30 dark:text-cyan-400',
  kiro: 'bg-rose-500/10 text-rose-600 border-rose-500/30 dark:text-rose-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  windsurf: 'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300',
  kiro: 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/10 dark:text-rose-300',
...
const BORDER: Record<Platform, string> = {
  ...
  windsurf: 'border-cyan-500/20 dark:border-cyan-500/20',
  kiro: 'border-rose-500/20 dark:border-rose-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  windsurf: 'bg-gradient-to-r from-cyan-400 to-cyan-500',
  kiro: 'bg-gradient-to-r from-rose-400 to-rose-500',
...
const TEXT: Record<Platform, string> = {
  ...
  windsurf: 'text-cyan-600 dark:text-cyan-400',
  kiro: 'text-rose-600 dark:text-rose-400',
...
const ICON: Record<Platform, string> = {
  ...
  windsurf: 'text-cyan-500 dark:text-cyan-400',
  kiro: 'text-rose-500 dark:text-rose-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  windsurf: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-600/80 dark:hover:bg-cyan-600',
  kiro: 'bg-rose-600 text-white hover:bg-rose-700 active:bg-rose-800 dark:bg-rose-600/80 dark:hover:bg-rose-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  windsurf: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300',
  kiro: 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  windsurf: 'from-cyan-500 to-cyan-600',
  kiro: 'from-rose-500 to-rose-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'windsurf' || p === 'kiro' || p === 'antigravity' || p === 'gemini'
}
