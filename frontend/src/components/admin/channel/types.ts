...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'windsurf': return 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400'
    case 'kiro': return 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'windsurf': return 'text-cyan-700 dark:text-cyan-400'
    case 'kiro': return 'text-rose-700 dark:text-rose-400'
