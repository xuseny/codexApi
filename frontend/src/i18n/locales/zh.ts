export default {
  ...
  keyExchange: {
    title: 'API Key 兑换',
    subtitle: '输入兑换码激活或查询 API Key 的额度与用量',
    codeLabel: '兑换码',
    placeholder: '请输入兑换码',
    button: '查询/激活',
    resolving: '处理中...',
    hint: '首次查询会自动激活兑换码；已激活的兑换码可继续查询额度和用量。',
    actionActivated: '兑换码已激活',
    actionQueried: '兑换码已查询',
    quota: '额度',
    quotaUsed: '已用额度',
    remainingQuota: '剩余额度',
    expiresAt: '到期时间',
    ...
    unlimited: '不限额',
    usageTitle: '用量统计',
    viewUsageDetails: '查看用量明细',
    todayCost: '今日费用',
    todayTokens: '今日 Token',
    totalCost: '累计费用',
    totalRequests: '累计请求',
    statusLabel: '状态',
    quotaRechargeTitle: '额度充值',
    quotaRechargeDescription: '使用额度兑换码为当前 API Key 追加额度。',
    quotaRechargeAvailable: '当前 API Key 支持额度充值',
    redeemCodeLabel: '额度兑换码',
    redeemCodePlaceholder: '请输入额度兑换码',
    quotaRecharging: '充值中...',
    quotaRechargeButton: '充值额度',
    quotaRechargeHint: '额度兑换码只能用于已激活且有限额的 API Key。',
    configTitle: '客户端配置',
    configDescription: '下载或保存客户端配置文件，快速使用当前 API Key。',
    saveSupported: '当前浏览器支持直接保存到本地',
    saveNotSupported: '当前浏览器不支持直接保存，请下载后手动导入',
    downloadConfig: '下载配置',
    saveToLocal: '保存到本地',
    previewConfig: '预览配置',
    apiBaseUrl: 'API 地址',
    configUnavailable: '激活兑换码后可生成配置文件',
    advancedToggle: '显示高级配置',
    apiKeyLabel: 'API Key',
    copyKey: '复制 Key',
    copyBaseUrl: '复制地址',
    usageDetailsTitle: '用量明细',
    usageDetailsEmpty: '暂无用量明细',
    group: '分组',
    firstToken: '首 Token',
    codeRequired: '请输入兑换码',
    quotaRechargeUnlimited: '不限额 API Key 无需充值额度',
    quotaRechargeExpired: 'API Key 已过期，无法充值',
    quotaRechargeDisabled: 'API Key 已禁用，无法充值',
    quotaRechargeUnavailable: '当前 API Key 暂不支持额度充值',
    usageDetailsFailed: '加载用量明细失败',
    savedSuccess: '配置已保存',
    savedFailed: '保存配置失败',
    resolveFailed: '兑换码查询失败',
    redeemCodeRequired: '请输入额度兑换码',
    quotaRechargeSuccess: '额度充值成功，增加 {amount} 美元额度',
  ...
  admin: {
    ...
    accounts: {
      ...
      batchHealthCheck: {
        title: '批量测活',
        description: '将使用所选模型测试 {count} 个账号的连接状态；返回 401 的账号会自动标记为错误状态。',
        modelPlaceholder: '选择或输入模型',
        modelHint: '模型列表来自第一个已选账号，也可以直接输入自定义模型 ID。',
        useCustomModel: '使用模型',
        loadingModels: '模型加载中...',
        start: '开始测活',
        running: '测活中...',
        ...
        statusUnauthorizedMarked: '401 已标记错误',
        successToast: '批量测活完成，{count} 个账号正常',
        partialToast: '批量测活完成：正常 {success} 个，失败 {failed} 个，已标记错误 {marked} 个',
        requestFailed: '批量测活请求失败'
      },
      bulkEdit: {
        title: '批量编辑账号',
    ...
    keyExchange: {
      ...
      linkedKey: '关联密钥',
      activatedAt: '激活时间',
      deleteConfirm: '确定要删除这条兑换码吗？此操作无法撤销。',
      batchDeleteTitle: '批量删除兑换码',
      batchDeleteConfirm: '确定要删除选中的 {count} 条兑换码吗？此操作无法撤销。',
      generateTitle: '生成兑换码',
      count: '数量',
      countHint: '最多可一次生成 500 条。',
      quotaHint: '填写 0 表示不限额。',
      expiresHint: '填写 0 表示永不过期。',
      batchNoHint: '可用于区分一批生成的兑换码。',
      notes: '备注',
      notesHint: '可选备注，仅管理员可见。',
      generatedSuccess: '兑换码生成成功',
      failedToLoad: '加载兑换码列表失败',
      deletedSuccess: '兑换码删除成功',
      failedToDelete: '删除兑换码失败',
      batchDeleteSuccess: '已删除 {count} 条兑换码',
      batchDeleteFailed: '批量删除兑换码失败',
      failedToGenerate: '生成兑换码失败'
    },
