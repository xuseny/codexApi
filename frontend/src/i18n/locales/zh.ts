export default {
  ...
  keyExchange: {
    title: 'API Key 兑换',
    subtitle: '输入兑换码，首次使用会生成 API Key，再次输入可查询同一个 Key。',
    placeholder: 'XXXX-XXXX-XXXX-XXXX',
    button: '获取或查询 API Key',
    resolving: '处理中...',
    actionActivated: '已成功生成 API Key',
    actionQueried: '已查询到现有 API Key',
    codeLabel: '兑换码',
    apiKeyLabel: 'API Key',
    apiBaseUrl: 'API 基础地址',
    copyKey: '复制 Key',
    ...
    quotaRechargeUnavailable: '当前 Key 状态不支持额度充值',
    quotaRechargeUnlimited: '这把 API Key 当前为不限额，无需额度充值',
    quotaRechargeDisabled: '已禁用的 API Key 不能在这里充值',
    quotaRechargeExpired: '已过期的 API Key 不能在这里充值',
    expiresAt: '过期时间',
    noExpiration: '不过期',
    todayCost: '今日消费',
    todayTokens: '今日TOKEN统计',
    totalCost: '累计消费',
    totalRequests: '累计请求',
    usageTitle: '使用情况',
    viewUsageDetails: '查看使用详情',
    usageDetailsTitle: 'API Key 使用详情',
    usageDetailsEmpty: '暂无调用记录',
    usageDetailsFailed: '加载使用详情失败',
    group: '分组',
    firstToken: '首TOKEN',
    activatedAt: '激活时间',
    statusLabel: '当前状态',
    ...
    selfHelpTitle: '自助处理在线占用',
    selfHelpDescription: '如果调用时提示 API Key 只能同时在线一台设备，可在这里执行踢下线后重试。',
    onlineDeviceTitle: '当前占用设备',
    onlineDeviceCurrent: '占用设备',
    onlineDeviceLastSeen: '最近活动',
    onlineDeviceEmpty: '当前没有检测到在线占用',
    kickOffline: '踢下线',
    kickingOffline: '踢下线中...',
    kickOfflineConfirmTitle: '确认踢下线',
    kickOfflineConfirmMessage: '这会清掉当前 API Key 的在线占用记录。原设备若仍在使用，下一次请求会被挤下线。是否继续？',
    kickOfflineSuccess: '已清除在线占用，请重新发起请求。',
    kickOfflineFailed: '踢下线失败，请稍后重试。',
    status: {
      active: '正常',
      disabled: '已禁用',
      expired: '已过期',
  ...
  keys: {
    ...
    batchDelete: '批量删除密钥',
    batchDeleteConfirm: '确定要删除选中的 {count} 个 API 密钥吗？此操作无法撤销。',
    apiKey: 'API 密钥',
    group: '分组',
    noGroup: '无分组',
    searchGroup: '搜索分组...',
    ...
    batchDeleteSuccess: '成功删除 {count} 个 API 密钥',
    ...
    batchDeleteFailed: '批量删除 API 密钥失败',
  ...
  admin: {
    ...
    accounts: {
      ...
      loadModelsFromApi: '读取模型列表',
      loadingModels: '读取中...',
      loadedModelsFromApi: '已读取 {count} 个模型',
      failedToLoadModels: '读取模型列表失败',
  ...
  keyExchange: {
      ...
      activated: '已激活',
      disabled: '已禁用',
      generateTitle: '生成 API Key 兑换码',
      count: '数量',
      countHint: '单次最多生成 500 个',
      quotaHint: '0 表示不限额',
      expiresHint: '0 表示不过期',
      batchNoHint: '留空将自动生成批次号',
      notesHint: '用于说明这批兑换码的用途',
      deleteConfirm: '确定删除这条兑换码吗？此操作无法撤销。',
      batchDeleteAction: '批量删除',
      batchDeleteTitle: '批量删除兑换码',
      batchDeleteConfirm: '确定要删除选中的 {count} 条兑换码吗？此操作无法撤销。',
      generatedSuccess: 'API Key 兑换码生成成功',
      deletedSuccess: 'API Key 兑换码删除成功',
      batchDeleteSuccess: '成功删除 {count} 条 API Key 兑换码',
      failedToLoad: '加载 API Key 兑换码失败',
      failedToGenerate: '生成 API Key 兑换码失败',
