export default {
  ...
  keyExchange: {
    ...
    subtitle: 'Enter an exchange code. The first use creates an API key, and later uses query the same key.',
    placeholder: 'XXXX-XXXX-XXXX-XXXX',
    button: 'Get or Query API Key',
    resolving: 'Processing...',
    actionActivated: 'API key generated successfully',
    actionQueried: 'Existing API key found',
    ...
    quotaRechargeUnavailable: 'Current key status does not allow quota recharge',
    quotaRechargeUnlimited: 'This API key is unlimited and does not need quota recharge',
    quotaRechargeDisabled: 'Disabled API keys cannot be recharged here',
    quotaRechargeExpired: 'Expired API keys cannot be recharged here',
    expiresAt: 'Expires At',
    noExpiration: 'Never expires',
    todayCost: 'Today Cost',
    todayTokens: 'Today Token Total',
    totalCost: 'Total Cost',
    totalRequests: 'Total Requests',
    usageTitle: 'Usage',
    viewUsageDetails: 'View Usage Details',
    usageDetailsTitle: 'API Key Usage Details',
    usageDetailsEmpty: 'No usage details yet',
    usageDetailsFailed: 'Failed to load usage details',
    group: 'Group',
    firstToken: 'First Token',
    activatedAt: 'Activated At',
    statusLabel: 'Current Status',
    configTitle: 'Client Config',
    configDescription: 'Sensitive values stay hidden by default. Use generated config files instead.',
    configUnavailable: 'No direct local config template is available for this group yet.',
    downloadConfig: 'Download Config',
    saveToLocal: 'Save To Local',
    previewConfig: 'Preview Config',
    saveSupported: 'Your browser supports choosing a local path and writing config files directly',
    saveNotSupported: 'Direct local file writing is not supported in this browser. Please download the config',
    savedSuccess: 'Config file saved successfully',
    savedFailed: 'Failed to save config file',
    advancedToggle: 'Advanced Info (expand only if you need manual setup)',
    selfHelpTitle: 'Self-service online lock reset',
    selfHelpDescription: 'If requests say this API key can only be online on one device, you can kick the current online device here and retry.',
    onlineDeviceTitle: 'Current online device',
    onlineDeviceCurrent: 'Occupied by',
    onlineDeviceLastSeen: 'Last seen',
    onlineDeviceEmpty: 'No current online lock detected',
    kickOffline: 'Kick Offline',
    kickingOffline: 'Kicking offline...',
    kickOfflineConfirmTitle: 'Confirm kick offline',
    kickOfflineConfirmMessage: 'This will clear the current online lock for this API key. If the original device is still using it, its next request will be forced offline. Continue?',
    kickOfflineSuccess: 'Online lock cleared. Please retry your request.',
    kickOfflineFailed: 'Failed to kick offline. Please try again later.',
    status: {
      active: 'Active',
      disabled: 'Disabled',
      expired: 'Expired',
  ...
  nav: {
    ...
    keyExchangeCodes: 'Key Exchange Codes',
    ops: 'Ops',
  ...
  keys: {
    ...
    batchDelete: 'Batch Delete API Keys',
    batchDeleteConfirm: 'Are you sure you want to delete the selected {count} API keys? This action cannot be undone.',
    apiKey: 'API Key',
    group: 'Group',
    noGroup: 'No group',
    ...
    batchDeleteSuccess: 'Deleted {count} API keys successfully',
    ...
    batchDeleteFailed: 'Failed to batch delete API keys',
  ...
  admin: {
    ...
    accounts: {
      ...
      loadModelsFromApi: 'Load model list',
      loadingModels: 'Loading...',
      loadedModelsFromApi: 'Loaded {count} model(s)',
      failedToLoadModels: 'Failed to load model list',
    ...
    keyExchange: {
      ...
      activated: 'Activated',
      disabled: 'Disabled',
      generateTitle: 'Generate API Key Exchange Codes',
      count: 'Count',
      countHint: 'Up to 500 codes per batch',
      quotaHint: '0 means unlimited',
      expiresHint: '0 means never expires',
      batchNoHint: 'Auto-generated when left empty',
      notesHint: 'Used to describe this batch',
      deleteConfirm: 'Delete this exchange code? This action cannot be undone.',
      batchDeleteAction: 'Batch Delete',
      batchDeleteTitle: 'Batch Delete Exchange Codes',
      batchDeleteConfirm: 'Are you sure you want to delete the selected {count} exchange codes? This action cannot be undone.',
      generatedSuccess: 'API key exchange codes generated successfully',
      deletedSuccess: 'API key exchange code deleted successfully',
      batchDeleteSuccess: 'Deleted {count} API key exchange codes successfully',
      failedToLoad: 'Failed to load API key exchange codes',
      failedToGenerate: 'Failed to generate API key exchange codes',
