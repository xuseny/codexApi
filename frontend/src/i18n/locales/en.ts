export default {
  ...
  keyExchange: {
    ...
    subtitle: 'Enter an exchange code to activate or query API Key quota and usage.',
    codeLabel: 'Exchange Code',
    placeholder: 'Enter exchange code',
    button: 'Query / Activate',
    resolving: 'Processing...',
    hint: 'The first query activates the code automatically. Activated codes can be queried again for quota and usage.',
    actionActivated: 'Exchange code activated',
    actionQueried: 'Exchange code queried',
    quota: 'Quota',
    quotaUsed: 'Quota Used',
    remainingQuota: 'Remaining Quota',
    expiresAt: 'Expires At',
    ...
    viewUsageDetails: 'View Details',
    todayCost: 'Today Cost',
    todayTokens: 'Today Tokens',
    totalCost: 'Total Cost',
    totalRequests: 'Total Requests',
    statusLabel: 'Status',
    quotaRechargeTitle: 'Quota Recharge',
    quotaRechargeDescription: 'Use a quota redeem code to add quota to the current API Key.',
    quotaRechargeAvailable: 'The current API Key supports quota recharge',
    redeemCodeLabel: 'Quota Redeem Code',
    redeemCodePlaceholder: 'Enter quota redeem code',
    quotaRecharging: 'Recharging...',
    quotaRechargeButton: 'Recharge Quota',
    quotaRechargeHint: 'Quota redeem codes can only be used for activated API Keys with finite quota.',
    configTitle: 'Client Configuration',
    configDescription: 'Download or save client configuration files for this API Key.',
    saveSupported: 'Your browser supports saving directly to local files',
    saveNotSupported: 'Your browser does not support direct save. Please download and import manually.',
    downloadConfig: 'Download Config',
    saveToLocal: 'Save Locally',
    previewConfig: 'Preview Config',
    apiBaseUrl: 'API Base URL',
    configUnavailable: 'Configuration is available after activating an exchange code',
    ...
    quotaRechargeUnlimited: 'Unlimited API Keys do not need quota recharge',
    quotaRechargeExpired: 'This API Key has expired and cannot be recharged',
    quotaRechargeDisabled: 'This API Key is disabled and cannot be recharged',
    quotaRechargeUnavailable: 'The current API Key does not support quota recharge',
    usageDetailsFailed: 'Failed to load usage details',
    savedSuccess: 'Configuration saved',
    savedFailed: 'Failed to save configuration',
    resolveFailed: 'Failed to query exchange code',
    redeemCodeRequired: 'Please enter a quota redeem code',
    quotaRechargeSuccess: 'Quota recharged successfully: +${amount}',
    quotaRechargeFailed: 'Failed to recharge quota',
    status: {
      active: 'Active',
      inactive: 'Inactive',
      quota_exhausted: 'Quota Exhausted',
  ...
  admin: {
    ...
    accounts: {
      ...
      batchHealthCheck: {
        ...
        description: 'Test connectivity for {count} selected account(s) with the selected model. Accounts returning 401 will be marked as error.',
        modelPlaceholder: 'Select or enter a model',
        modelHint: 'Model options come from the first selected account. You can also enter a custom model ID.',
        ...
        statusUnauthorizedMarked: '401 Marked Error',
        successToast: 'Batch health check completed: {count} account(s) healthy',
        partialToast: 'Batch health check completed: {success} healthy, {failed} failed, {marked} marked error',
        requestFailed: 'Batch health check request failed'
      },
      bulkEdit: {
    ...
    keyExchange: {
      searchPlaceholder: 'Search codes or linked key...',
      ...
      batchDeleteTitle: 'Delete Codes in Bulk',
      batchDeleteConfirm: 'Are you sure you want to delete the selected {count} codes? This action cannot be undone.',
      generateTitle: 'Generate Codes',
      count: 'Count',
      countHint: 'Up to 500 codes can be generated at once.',
      quotaHint: 'Set to 0 for unlimited quota.',
      expiresHint: 'Set to 0 for no expiration.',
      batchNoHint: 'Used to group codes generated in the same batch.',
      notes: 'Notes',
      notesHint: 'Optional notes visible to administrators only.',
      generatedSuccess: 'Codes generated successfully',
      failedToLoad: 'Failed to load code list',
      deletedSuccess: 'Code deleted successfully',
      failedToDelete: 'Failed to delete code',
      batchDeleteSuccess: 'Deleted {count} codes successfully',
      batchDeleteFailed: 'Failed to delete codes in bulk',
      failedToGenerate: 'Failed to generate codes'
    },
